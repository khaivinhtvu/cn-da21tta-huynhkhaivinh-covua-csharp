...
public class KnightScript : MonoBehaviour
{
    ...
    public static event MoveInfo ShowKnightMoveInfo;
    ...
    private void BroadMatrix()
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            for (int j = 0; j < 8; j++)
            {
                ...
                {
                    Debug.Log("found knight location");
                    Debug.Log("knight location: " + i + ", " + j);
                    location[0] = i;
                    location[1] = j;
                    stop = 1;
                    break;
    ...
    private void MoveScan()
    {
        ...
        if (location[0] + 2 < 8 && location[1] + 1 < 8)
        {
            ...
            {
                amove[0, 0] = location[0] + 2;
                amove[0, 1] = location[1] + 1;
            }
            if (matran[location[0] + 2, location[1] + 1].Contains("b") && pieceId.Contains("w"))
            {
                aattack[0, 0] = location[0] + 2;
        ...
        if (location[0] - 1 >= 0 && location[1] + 2 < 8)
        {
            if (matran[location[0] - 1, location[1] + 2].Contains("0"))
            {
                ...
                amove[3, 1] = location[1] + 2;
            }
            if (matran[location[0] - 1, location[1] + 2].Contains("b") && pieceId.Contains("w"))
            {
                aattack[3, 0] = location[0] - 1;
                aattack[3, 1] = location[1] + 2;
            }
            if (matran[location[0] - 1, location[1] + 2].Contains("w") && pieceId.Contains("b"))
            {
                aattack[3, 0] = location[0] - 1;
        ...
        if (location[0] - 2 >= 0 && location[1] + 1 < 8)
        {
            if (matran[location[0] - 2, location[1] + 1].Contains("0"))
            {
                amove[4, 0] = location[0] - 2;
                amove[4, 1] = location[1] + 1;
            }
            if (matran[location[0] - 2, location[1] + 1].Contains("b") && pieceId.Contains("w"))
            {
                aattack[4, 0] = location[0] - 2;
        ...
        if (location[0] - 2 >= 0 && location[1] - 1 >= 0)
        {
            if (matran[location[0] - 2, location[1] - 1].Contains("0"))
            {
                amove[5, 0] = location[0] - 2;
                amove[5, 1] = location[1] - 1;
            }
            if (matran[location[0] - 2, location[1] - 1].Contains("b") && pieceId.Contains("w"))
            {
                aattack[5, 0] = location[0] - 2;
        ...
        if (location[0] + 1 < 8 && location[1] - 2 >= 0)
        {
            if (matran[location[0] + 1, location[1] - 2].Contains("0"))
            {
                ...
                amove[6, 1] = location[1] - 2;
            }
            if (matran[location[0] + 1, location[1] - 2].Contains("b") && pieceId.Contains("w"))
            {
                aattack[6, 0] = location[0] + 1;
                aattack[6, 1] = location[1] - 2;
            }
            if (matran[location[0] + 1, location[1] - 2].Contains("w") && pieceId.Contains("b"))
            {
                aattack[6, 0] = location[0] + 1;
        ...
        if (location[0] - 1 >= 0 && location[1] - 2 >= 0)
        {
            if (matran[location[0] - 1, location[1] - 2].Contains("0"))
            {
                ...
                amove[7, 1] = location[1] - 2;
            }
            if (matran[location[0] - 1, location[1] - 2].Contains("b") && pieceId.Contains("w"))
            {
                aattack[7, 0] = location[0] - 1;
                aattack[7, 1] = location[1] - 2;
            }
            if (matran[location[0] - 1, location[1] - 2].Contains("w") && pieceId.Contains("b"))
            {
                aattack[7, 0] = location[0] - 1;
    ...
    private void RaiseMoveInfo()
    {
        ...
        ShowKnightMoveInfo?.Invoke(location, amove, positionx, positiony, pieceId, aattack);
    }
